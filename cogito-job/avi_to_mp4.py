...
vid_place='C:/Users/ianre/Desktop/Academica/Research/s_aw_demo/demovids/*'
mypath=r'C:/Users/ianre/Desktop/Academica/Research/s_aw_demo/demovids/'
# print(vid_place)
...
def convert_avi_to_mp4(avi_file_path, output_name):
    ...
    os.popen("C:\\FFmpeg\\bin\\ffmpeg.exe -i " + avi_file_path + " -y " + output_name)
    print("::convert::")
    return True
